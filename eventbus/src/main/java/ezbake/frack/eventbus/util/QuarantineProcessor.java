...
public class QuarantineProcessor extends QuarantineClient {
     ...
     */
    public void sendRawToQuarantine(String pipeId, byte[] data, Visibility visibility, String error, AdditionalMetadata additionalMetadata) throws IOException {
     ...
     * @param error a string describing the reason for failure
     */
    public void sendObjectToQuarantine(String pipeId, Serializable object, Visibility visibility, String error, AdditionalMetadata additionalMetadata) throws IOException {
