...
public class INSUtilTest {
    ...
    public void getINSInfoTest() throws Exception {
        ...
        InternalNameService.Client mockClient = when(mock(InternalNameService.Client.class).getTopicsForFeed(appId, feedName)).thenReturn(Sets.newHashSet(topic)).getMock();
